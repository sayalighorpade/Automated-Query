	...
	<div id="templatemo_middle" align="center">
        ...
        <div id="templatemo_content" align="center" style="width: 100%">
            ...
            <div class="content_box_wrapper" align="center">
            	<div class="content_box">
                   ...
                   <form  action="LoginPage" method="post">
					...
					<h2>Search History Results</h2>
              <table border="1" style="width: 100%; margin-right: 55px">
              <tr>
          ...
          Connection conn=Dbconn.conn();
					String searchword=(String)session.getAttribute("Query1");
         System.out.println("Word"+searchword);
          Statement st3=conn.createStatement();
          	   ResultSet rs2 =st3.executeQuery("SELECT * from trainningdata where searchphrase like '%"+searchword+"%'");
        	   while(rs2.next())
        	   {
        		   %>
        		   <tr> 
