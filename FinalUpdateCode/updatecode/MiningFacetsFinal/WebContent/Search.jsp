...
<div id="templatemo_middle_wrapper">
	<div id="templatemo_middle" align="center">
       ...
       <form  action="SearchServlet"  id="myform"   method="post">  
        <table   class="fileup"  border="0" cellspacing="10" cellpadding="11" style="font-family: monotype corsiva;font-size: 22px;">
									...
									String Searchword;
										Statement statement = connection.createStatement();
											...
											.executeQuery("select * from trainningdata where username='"+Username+"' Order by id desc ");
											int i = 0;
										if (resultset.next()) {
											if (i == 0) {
						...
						%>
									<td style="font-family: cursive; font-size: 15px;color: white;">
									<big>UserName:-<%=resultset.getString(2)%></big><br/>
										<big>Last Search Word:-<%=resultset.getString(3)%></big><br/>
                  ...
                  <tr>  
                  <td>        <table style="padding-top: 0px;">
												<tr>
							<td class="lable" style="padding-top: 20px;">Enter Query:</td>
							<td style="padding-top: 20px;"><input type="text" 
								name="txtUsername" required style="height: 25px; width: 150px;" /></td>
						</tr>
						<tr><td> </td>
							<td colspan="2" style="padding-top: 20px;"><input
								type="submit" value="Search"  style="height: 30px;"/>
