...
<script>
 ...
 Statement st;
 ResultSet rs;
 String sql="select * from countmaster where searchword='"+searchword+"' ";
 ...
 {
	 vcs=rs.getString(2);
	 tfidf=rs.getString(4);
	 vcstime=(rs.getInt("vcstime") / 1000) % 60;
	 tfidftime=(rs.getInt("tfidftime") / 1000) % 60;
    ...
    $(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'Calculation Time Vcs and TfIdf'
            },
            subtitle: {
            ...
            xAxis: {
            	 title: {
                     text: 'Vcs and TfIdf Name'
                 },
            	categories: ['Vcs(<%=vcs%>)','TfIdf(<%=tfidf%>)']
                
            },
            yAxis: {
            	 title: {
                     text: 'Time Count Second'
                 },
            ...
            tooltip: {
                pointFormat: '<b>{point.y:1f}s</b>'
            },
            series: [{
            	name: 'Time(S)',
                data: [<%=vcstime%>,<%=tfidftime%>],
                dataLabels: {
                    enabled: false,
                    rotation: -90,
                    color: '#FFFFFF',
        ...
        <div id="templatemo_content" align="center" style="width: 100%">
            ...
            <div class="content_box_wrapper" align="center">
            	<div class="content_box">
                   ...
                   <div id="container" style="min-width: 500px; height: 500px; max-width: 350px; margin: 0 auto"></div>
