            ...
            <div class="content_box_wrapper" align="center">
            	<div class="content_box">
                   ...
                   <form  action="LoginPage" method="post">
						...
						<table align="left"class="fileup"  border="0" cellspacing="10" cellpadding="11" style="font-family: monotype corsiva;font-size: 22px;">
									...
									String Searchword;
										Statement statement = connection.createStatement();
											...
											.executeQuery("select * from history where username='"+Username+"' Order by Date desc ");
											int i = 0;
						...
						%>
									...
									<big>UserName:-<%=resultset.getString(2)%></big><br/>
										<big>SearchWord:-<%=resultset.getString(1)%></big><br/>
										<big>SearchDate:-<%=resultset.getString(3)%></big><br/> 
										-----------------------------------------
										</td>
