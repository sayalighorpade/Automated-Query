...
<div id="templatemo_middle_wrapper">
	<div id="templatemo_middle" align="center">
        ...
        <div id="templatemo_content" align="center" style="width: 100%">
			...
			<table border="1" style="width: 100%; margin-right: 15px">
               <tr>
               <td>
               Url Name
               </td>
        ...
        double tfidf,qt=0.93,qt1=0.50,qt2=0.75,qt3=1.00;
        	   
          //where searchword='"+searchword+"'
        	   ResultSet rs2 =st3.executeQuery("select * from facetmaster where searchword='"+searchword+"' order by  clusterno desc");
        	   while(rs2.next())
        	   {
        		  ...
        		  <tr>  
             <td> 
        	  	<a href="<%=rs2.getString("url") %>"> <%=rs2.getString("url") %></a> <br/> 
        	  	</td>
        	  	<td><%=rs2.getString("clusterno") %>
